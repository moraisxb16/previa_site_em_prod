  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: 'Mesmo diante de um cenário desafiador, entendemos que era o momento de investir em mais um empreendimento na cidade de São Paulo, e o resultado não seria atingido com excelência se não pudéssemos contar com a parceria e todo o suporte da SOS Resolve Soluções Imobiliárias desde o projeto até a conclusão, obedecendo todos os requisitos legais oriundos de um grande empreendimento.',
    ...
    },
    {
      ...
      rating: 5,
      text: 'A SOS Resolve Soluções Imobiliárias nos auxiliou em todo o processo de licenciamento do nosso complexo comercial. Demonstraram profundo conhecimento técnico e agilidade na resolução de questões complexas junto aos órgãos públicos. O projeto foi aprovado dentro do prazo.',
    ...
    },
    {
      ...
      rating: 5,
      text: 'Contratamos a SOS Resolve Soluções Imobiliárias para realizar o Estudo de Viabilidade Técnica e Legal de um terreno estratégico. A análise foi completa e nos deu total segurança para prosseguir com o investimento. Atendimento aos prazos impecável.',
    ...
    },
    {
      ...
      rating: 5,
      text: 'Precisávamos regularizar diversos pontos de venda em São Paulo e a SOS Resolve Soluções Imobiliárias conduziu todo o processo com maestria. Obtivemos todos os AVCBs e alvarás necessários. Equipe técnica extremamente competente e comprometida.',
    ...
    },
    {
      ...
      rating: 5,
      text: 'Tivemos suporte completo na obtenção de certificados e regularização documental. A SOS Resolve Soluções Imobiliárias foi transparente em cada etapa e entregou tudo com planejamento e previsibilidade.',
    ...
    },
    {
      ...
      rating: 5,
      text: 'A parceria com a SOS Resolve Soluções Imobiliárias elevou nosso padrão de entrega em aprovações. Eles dominam o processo, antecipam riscos e conduzem a documentação com excelência, reduzindo retrabalho.',
      highlight: 'Expertise técnica',
      date: 'Agosto 2025',
      verified: true,
    },
